...
datatsunami="../input/restricciones_tsunami_winckler.csv"
rosa="dg-78/-36+w1c+f+l,,,n"
paletarunup="/home/ignacia/Documentos/Rodrigo/magister/Tesis/modelos/paletas/subtle.cpt"
########################################
#p delays
####################
#basemap and coast
...
gmt makecpt -C${paletarunup} -T0/25/0.1 -Z > paletarunup.cpt
...
# datos run up
more ${datatsunami} | awk -F"," '{if ($4!="nan") print $2, $3, $4/20}' | gmt psxy -J -R -P -V  -S+ -W1.0p,red3 -O -K >> ${psfile}
# datos llegada
...
END
#titulo
gmt pstext << END -R -J -P -V -F+f7p,Helvetica-Bold,black+jMC -N -O -K >> ${psfile}
-68.75 -44.75 5 m
-68.8 -45.3 10 m
-68.8 -46.1 15 m
-68.8 -47.15 20 m
