...
path_slip="/home/ignacia/Documentos/Javiera2/1906/bundle/fallas/modelos_restringidos_magnitud"
os.chdir(path_slip)
...
lista_idx_rest = np.genfromtxt("lista_idx_modelos.txt") # lista con los id de los modelos originales que pasaron la restriccion
